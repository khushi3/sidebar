(function () {
    ...
    function ngDuallist($rootScope, $filter, $parse) {
        ...
        function link(scope, element, attrs, controller) {
            ...
            if (scope.duallistOption.leftContainerScrollEnd) { // execute the left container scroll end event
            ...
            if (scope.duallistOption.rightContainerScrollEnd) { // execute the right contained scroll end event
            ...
            if (scope.duallistOption.leftContainerSearch) { //left search text change
            ...
            if (scope.duallistOption.rightContainerSearch) { //right search text change
            ...
            if (scope.duallistOption.onMoveRight) { //right search text change
            ...
            if (scope.duallistOption.onMoveLeft) { //left search text change
